...
// ***********************************************************************
// <copyright file="TypeSignatureGenerator.cs" company="KsWare">
...
namespace KsWare.SignatureGenerator.Generators {
	...
	/// <autogeneratedoc />
	public class TypeSignatureGenerator : BaseSignatureGenerator {

		/// <summary>
		/// Initializes a new instance of the <see cref="TypeSignatureGenerator"/> class.
		/// </summary>
		/// <param name="signatureHelper">The signature helper.</param>
		/// <autogeneratedoc />
		public TypeSignatureGenerator(SignatureHelper signatureHelper) : base(signatureHelper) { }
