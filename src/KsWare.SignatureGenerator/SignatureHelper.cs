...
using KsWare.SignatureGenerator.Generators;
...
namespace KsWare.SignatureGenerator {
	...
	public partial class SignatureHelper {
		...
		private FieldSignatureGenerator     _fieldSignatureGenerator;
		private EventSignatureGenerator     _eventSignatureGenerator;
		private MethodSignatureGenerator    _methodSignatureGenerator;
		private ParameterSignatureGenerator _parameterSignatureGenerator;
		private PropertySignatureGenerator  _propertySignatureGenerator;
		private TypeSignatureGenerator      _typeSignatureGenerator;
		...
		/// </summary>
		/// <autogeneratedoc />
		public static readonly SignatureHelper ForInheriteDoc = new SignatureHelper(SignatureMode.InheriteDoc);

		/// <summary>
		/// For signature
		/// </summary>
		/// <autogeneratedoc />
		public static readonly SignatureHelper ForSignature = new SignatureHelper(SignatureMode.Signature);

		/// <summary>
		/// For call
		/// </summary>
		/// <autogeneratedoc />
		public static readonly SignatureHelper ForCall = new SignatureHelper(SignatureMode.Call);

		/// <summary>
		/// For declare
		/// </summary>
		/// <autogeneratedoc />
		public static readonly SignatureHelper ForDeclare = new SignatureHelper(SignatureMode.Declare);
		...
		private SignatureHelper(SignatureMode signatureMode) {
			...
			_fieldSignatureGenerator=new FieldSignatureGenerator(this);
			_eventSignatureGenerator=new EventSignatureGenerator(this);
			_methodSignatureGenerator=new MethodSignatureGenerator(this);
			_parameterSignatureGenerator=new ParameterSignatureGenerator(this);
			_propertySignatureGenerator=new PropertySignatureGenerator(this);
			_typeSignatureGenerator=new TypeSignatureGenerator(this);
		}
		...
		public string Sig(EventInfo eventInfo) => _eventSignatureGenerator.Sig(eventInfo);
		...
		/// <returns>System.String.</returns>
		public string Sig(MethodInfo methodInfo) => _methodSignatureGenerator.Sig(methodInfo);
		...
		/// <returns>System.String.</returns>
		public string Sig(ConstructorInfo constructorInfo) => _methodSignatureGenerator.Sig(constructorInfo);
		...
		/// <returns>System.String.</returns>
		public string Sig(ParameterInfo parameterInfo) => _parameterSignatureGenerator.Sig(parameterInfo);
		...
		/// <returns>System.String.</returns>
		public string Sig(PropertyInfo propertyInfo) => _propertySignatureGenerator.Sig(propertyInfo);
		...
		/// <returns>System.String.</returns>
		public string Sig(Type type) => _typeSignatureGenerator.Sig(type);
		...
		/// <returns>System.String.</returns>
		public string Sig(FieldInfo fieldInfo) => _fieldSignatureGenerator.Sig(fieldInfo);
