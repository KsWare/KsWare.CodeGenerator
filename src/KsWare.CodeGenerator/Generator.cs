...
namespace KsWare.CodeGenerator {
	...
	public partial class Generator {
		...
		public string Generate(MethodAttributes attr) {
			...
			sb.Append(Access(attr));
			sb.Append(Modifier(attr));
		...
		/// <param name="attr">The attribute.</param>
		/// <returns>System.String.</returns>
		public string Access(MethodAttributes attr) {
		...
		public string Generate(FieldAttributes attr) {
			var sb = new StringBuilder();
			sb.Append(Access((MethodAttributes) attr));
			sb.Append(Modifier(attr));
			return sb.ToString();
		}
		...
		/// <param name="attr">The attribute.</param>
		/// <returns>System.String.</returns>
		public string Modifier(FieldAttributes attr) {
			/*
		...
		public string MaxAccess(string a, string b) {
			if (string.IsNullOrEmpty(a)) throw new ArgumentNullException("Access");
			if (string.IsNullOrEmpty(b)) throw new ArgumentNullException("Access");
			var ai = Array.IndexOf(accessPrio,a.Trim());
			var bi = Array.IndexOf(accessPrio, b.Trim());
			if (ai < 0) throw new ArgumentOutOfRangeException("Access");
			if (bi < 0) throw new ArgumentOutOfRangeException("Access");
